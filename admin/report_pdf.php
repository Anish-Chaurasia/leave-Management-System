<?php
	...
	class PDF extends TCPDF
	{
	    public function Header()
	    {
	    	...
	    	$this->Cell(189, 5, 'THDC Institute of Hydro Power Engineering and Technology', 0, 1, 'C');
	    	$this->SetFont('helvetica','B', 14);
	    	$this->Ln(2);
	    	$this->Cell(189, 3, 'Tehri, Uttarakhand', 0, 1, 'C');
	    	$this->SetFont('helvetica','B', 14);
	    	$this->Ln(2);
	...
	$pdf->SetAuthor('THDC IHET Leave Portal');
	$pdf->SetTitle('THDC IHET Leave Portal');
	$pdf->SetSubject('');
	$pdf->SetKeywords('');
